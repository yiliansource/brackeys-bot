...
namespace BrackeysBot
{
    ...
    {
        private const string propertyDisplayNamePrefix = "spamSettings.";

        [YamlMember(Alias = "muteDuration")]
        [ConfigCommandDisplayName(propertyDisplayNamePrefix + "muteDuration")]
        ...
        [ConfigCommandDisplayName(propertyDisplayNamePrefix + "consecutiveWordThreshold")]
        ...
        [ConfigCommandDisplayName(propertyDisplayNamePrefix + "fullMessageWordThreshold")]
        ...
        [ConfigCommandDisplayName(propertyDisplayNamePrefix + "includeMentions")]
        ...
        [ConfigCommandDisplayName(propertyDisplayNamePrefix + "mentionsThreshold")]
        ...
        [ConfigCommandDisplayName(propertyDisplayNamePrefix + "includeEmotes")]
        ...
        [ConfigCommandDisplayName(propertyDisplayNamePrefix + "checkForDefaultEmotes")]
        ...
        [ConfigCommandDisplayName(propertyDisplayNamePrefix + "emotesThreshold")]
